  ...
  render(){
    return(
      <div className="container-fluid contact">
        ...
        <div className="cv">
          <a href="https://drive.google.com/file/d/1aLTJp1fiDU8CGsnrmrc2wn166ZgtVDT0/view?usp=sharing" target="_blank" className="anchor">
            <img src={cv} alt=""/> <h3>See my CV</h3>
          </a>
        </div>
        <div className="cv">
          <a href="mailto:nicoposa57@gmail.com" target="_blank" className="anchor">
